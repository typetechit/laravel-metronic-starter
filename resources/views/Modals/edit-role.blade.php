		...
		<div class="modal-content">
			...
			<div class="modal-body px-5 my-7">
				...
				<form id="kt_modal_edit_role_form" class="form" method="POST" action="">
					@csrf
					@method('PUT')
					<input type="hidden" name="role_id" id="edit-role-id" value="" /> <!-- Hidden field for role ID -->
					<!--begin::Scroll-->
					<div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_role_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_role_header" data-kt-scroll-wrappers="#kt_modal_add_role_scroll" data-kt-scroll-offset="300px">
						...
						<div class="fv-row mb-7">
							...
							<!--end::Label-->
							<!--begin::Input-->
							<input type="text" required name="name" class="form-control form-control-solid mb-3 mb-lg-0" id="edit-role-title" placeholder="Role name" />
							<!--end::Input-->
						</div>
						<!--end::Input group-->
					</div>
